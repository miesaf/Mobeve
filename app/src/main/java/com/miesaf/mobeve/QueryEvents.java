...
public class QueryEvents {
    ...
    public static ArrayList<Events> extractCarsDetails() {

        ArrayList<Events> cars = new ArrayList<>();
        ...
        try {
            ...
            for (int i = 1; i < jsonArray.length(); i++) {
                ...
                String evn_id = properties.optString("evn_id");
                String evn_name = properties.optString("evn_name");
                String evn_leader = properties.optString("evn_leader");
                String evn_start = properties.optString("evn_start");
                String evn_end = properties.optString("evn_end");
                String evn_type = properties.optString("evn_type");

                Events carsDetails = new Events(evn_id, evn_name, evn_leader, evn_start, evn_end, evn_type);
