				...
				elseif($RuleLevel == "3")
				{
					...
					if($T_Rule["known_facts"][1]["ans_6"] == "Committee Member"){
						if($T_Rule["known_facts"][2]["ans_6"] == "Yes"){
							appendTask($T_Data, "Planning and Execution", "Award lecturer with emoluments");
						}
					...
					if($T_Rule["known_facts"][1]["ans_7"] == "Yes"){
						appendTask($T_Data, "Logistics", "Setup audio system for the talk");
						appendTask($T_Data, "Special Task Force", "Become microphone runner during QnA session");
					}
					
					if($T_Rule["known_facts"][1]["ans_8"] == "Formal"){
						...
						if($T_Rule["known_facts"][2]["ans_9"] == "Yes"){
					...
					}elseif($T_Rule["known_facts"][1]["ans_8"] == "Informal"){
						if($T_Rule["known_facts"][2]["ans_7"] == "Yes"){
							appendTask($T_Data, "Food", "Arrange VIP dining place");
							appendTask($T_Data, "Food", "Serve the VIPs for banquet");
						}
