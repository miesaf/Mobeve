...
public class RuleWshop1Activity extends AppCompatActivity {
    ...
    private void ProcessRule(String evn_id, String a1, String a2, String a3, String a4, String a5, String a6, String a7) {
        displayLoader();
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (response.getInt(KEY_STATUS) == 0) {
                                ...
                                //Intent i = new Intent(getApplicationContext(), RuleWshop2Activity.class);
