...
public class RuleWshop1Activity extends AppCompatActivity {
    ...
    private String rule_url = "https://dimensikini.xyz/api/mobeve/wshop_rules_engine.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rule_wshop1);
        ...
        BtnCancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(RuleWshop1Activity.this, DashboardActivity.class);
                startActivity(i);
                finish();
            }
        });
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (response.getInt(KEY_STATUS) == 0) {
                                ...
                                Intent ruleIntent = new Intent(RuleWshop1Activity.this, RuleWshop2Activity.class);
