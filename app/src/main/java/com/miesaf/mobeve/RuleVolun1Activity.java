...
public class RuleVolun1Activity extends AppCompatActivity {
    ...
    private String rule_url = "https://dimensikini.xyz/api/mobeve/volun_rules_engine.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rule_volun1);
        ...
        EvnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ProcessRule(evn_id, Answ1, Answ2, Answ3, Answ4, Answ5, Answ6, Answ7);
        ...
        BtnCancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(RuleVolun1Activity.this, RuleVolun2Activity.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void ProcessRule(final String res_evn_id, String a1, String a2, String a3, String a4, String a5, String a6, String a7) {
        displayLoader();
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (response.getInt(KEY_STATUS) == 0) {
                                ...
                                Intent ruleIntent = new Intent(RuleVolun1Activity.this, RuleVolun2Activity.class);
