...
public class RuleTalk2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rule_talk2);
        ...
        EvnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ProcessRule(evn_id, Answ1, Answ2, Answ3, Answ4, Answ5, Answ6, Answ7, Answ8, Answ9);
            }
        });
        ...
        BtnCancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(RuleTalk2Activity.this, DashboardActivity.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void ProcessRule(final String evn_id, String a1, String a2, String a3, String a4, String a5, String a6, String a7, String a8, String a9) {
        displayLoader();
